                                        ...
                                        <li class="project-board-card-thumbnail text-right" style="float:right;">
                                            ...
                                            <a href="/home" class="topbar-user__list-link">
                                                ...
                                                <span class="user__list-icon">
                                                   <img src="{{$task->user->image}}" class="thumbnail" alt="" srcset="" style="max-width: 45px!important; border-radius:100px; margin-right:-10%;" title="{{$task->user->name}}">
                                                </span>
...
<div class="row movedown">
            ...
            <div class="tablet__body">
                ...
                <li>
                    ...
                    <span class="user__list-icon" style="display:flex; justify-content:center;">
                       <img src="{{$collaborator->image}}" class="thumbnail" title="{{$collaborator->name}}" alt="" srcset="" style="max-width: 50px!important; border-radius:100px;">
                    </span>
    ...
    @else
        ...
        <span class="user__list-icon" style="display:flex; justify-content:center;">
           <img src="https://p.kindpng.com/picc/s/451-4517876_default-profile-hd-png-download.png" class="thumbnail" title="{{$collaborator->name}}" alt="" srcset="" style="max-width: 50px!important; border-radius:100px;">
        </span>
