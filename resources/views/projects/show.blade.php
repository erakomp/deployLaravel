        ...
        <div class="project-board-ui">
            ...
            <div class="project-board-lists">
                ...
                <div class="project-board-list" style="background-color:{{$status->color}};">
                    ...
                    <ul class="sortable" id="{{$status->title}}" data-status-external-id="{{$status->external_id}}" style="max-height: 25em; min-height:30em;"  >
...
<div class="row movedown">
    ...
    @else
        ...
        <span class="user__list-icon" style="display:flex; justify-content:center;">
           <img src="https://p.kindpng.com/picc/s/451-4517876_default-profile-hd-png-download.png" class="thumbnail rounded" title="{{$collaborator->name}}" alt="" srcset="" style="max-width: 50px!important; border-radius:100px;">
        </span>
