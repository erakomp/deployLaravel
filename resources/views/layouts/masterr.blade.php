        ...
        <nav id="myNavmenu" class="navmenu navmenu-default navmenu-fixed-left offcanvas-sm" role="navigation"
            ...
            <div class="list-group panel">
                ...
                <a href="/" class="list-group-item" data-parent="#MainMenu">
                    ...
                    <span id="menu-txt" style="font-size: 16px!important;" style="font-size: 16px!important;"
                        style='font-size: 16px!important;'> {{__('Dashboard') }}</span></a>
                ...
                <div class="collapse" id="projects">
                    <a href="{{ route('projects.index') }}" class="list-group-item childlist"
                        style="font-size: 13px!important;"> <i class="bullet-point"><span></span></i>
                        {{ __('All
                        Projects') }}</a>
                ...
                <div class="collapse" id="settings">
                    ...
                    <a href="/test" class="list-group-item childlist" style="font-size: 13px!important;">
                        <i class="bullet-point"><span></span></i>Get QC & Done KPI Report</a>
                    @endif
                    @if (Auth::user()->user_flag == 2)
                ...
                <div class="collapse" id="settings">
                    <a href="{{ route('roles.index') }}" class="list-group-item childlist"
                        style="font-size: 16px!important;"> <i class="bullet-point"><span></span></i>
                        {{ __('Role &
                        Permissions Management') }}</a>
                </div>
                @endif
                ...
                <div class="collapse" id="settings">
                    <a href="{{ route('roles.index') }}" class="list-group-item childlist"> <i
                            class="bullet-point"><span></span></i>
                        {{ __('Role & Permissions Management') }}</a>
                </div>
                @endif
    ...
    <script>
        $(document).ready(function() {
                $.extend($.fn.pickadate.defaults, {
                    monthsFull: ['januar', 'februar', 'marts', 'april', 'maj', 'juni', 'juli', 'august',
                        'september', 'oktober', 'november', 'december'
                    ],
                    monthsShort: ['jan', 'feb', 'mar', 'apr', 'maj', 'jun', 'jul', 'aug', 'sep', 'okt', 'nov',
                        'dec'
                    ],
