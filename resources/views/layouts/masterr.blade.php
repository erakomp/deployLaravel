    ...
    <div id="wrapper">
        ...
        <nav id="myNavmenu" class="navmenu navmenu-default navmenu-fixed-left offcanvas-sm" role="navigation"
            ...
            <div class="list-group panel">
                ...
                <p class=" list-group-item siderbar-top" title=""><img src="{{Auth::user()->image}}" alt=""
                        style="width: 70%; margin: 1em 0; margin-left:15%; border-radius:100px;" class="img-rounded">
                </p>
                @elseif(Auth::user()->image == NULL)
                <p class=" list-group-item siderbar-top" title=""><img
                        src="https://www.baytekent.com/wp-content/uploads/2016/12/facebook-default-no-profile-pic1.jpg"
                        alt="" style="width: 70%; margin: 1em 0; margin-left:15%; border-radius:100px;"
                        class="img-rounded"></p>
                @endif
                <a href="#" class=" list-group-item" data-parent="#MainMenu" disabled="disabled"
                    style="pointer-events: none!important; text-align:center;"><span id="menu-txt"
                ...
                <a href="/userr" class=" list-group-item" data-parent="#MainMenu"><i
                        class="fas fa-user-edit sidebar-icon"></i><span id="menu-txt"
                        style="font-size: 16px!important;">Edit Profile</span></a>
                {{-- <a href="/labels" class=" list-group-item" data-parent="#MainMenu"><i
                        class="fas fa-tags sidebar-icon"></i><span id="menu-txt" style="font-size: 16px!important;">Tags
                    </span></a> --}}

                @if(Entrust::hasRole('owner'))
                <a href="/" class=" list-group-item" data-parent="#MainMenu"><i
                        class="fa fa-home sidebar-icon"></i><span id="menu-txt" style="font-size: 16px!important;">{{
                        __('Dashboard') }} </span></a>
                <a href="/labels" class=" list-group-item" data-parent="#MainMenu"><i
                        class="fas fa-tags sidebar-icon"></i><span id="menu-txt" style="font-size: 16px!important;">Tags
                    </span></a>
                ...
                <a href="#projects" class="list-group-item" data-toggle="collapse" data-parent="#MainMenu"><i
                        class="fa fa-briefcase sidebar-icon "></i><span id="menu-txt"
                        style="font-size: 16px!important;">{{ __('Projects') }}</span>
                ...
                <div class="collapse" id="projects">
                    <a href="{{ route('projects.index')}}" class="list-group-item childlist"
                        style="font-size: 13px!important;"> <i class="bullet-point"><span></span></i> {{ __('All
                        Projects') }}</a>
                    @if(Entrust::can('project-create'))
                    <a href="{{ route('projects.create')}}" id="newProject" class="list-group-item childlist"
                        style="font-size: 13px!important;"> <i class="bullet-point"><span></span></i> {{ __('New
                        Project') }}</a>
                    @endif
                </div>
            ...
            <div class="collapse" id="tasks">
                ...
                <div class="collapse" id="user">
                    <a href="{{ route('productss.index')}}" class="list-group-item childlist"
                        style="font-size: 13px!important;"> <i class="bullet-point"><span></span></i> {{ __('All Users')
                        }}</a>
                    @if(Entrust::can('user-create'))
                    <a href="{{ route('productss.create')}}" class="list-group-item childlist"
                        style="font-size: 13px!important;"> <i class="bullet-point"><span></span></i> {{ __('New User')
                        }}
                    </a>
                    <a href="/pegawa" class="list-group-item childlist" style="font-size: 13px!important;"> <i
                            class="bullet-point"><span></span></i> Register Roles
                    </a>
                    <a href="{{ route('roles.index')}}" class="list-group-item childlist"
                        style="font-size: 13px!important;"> <i class="bullet-point"><span></span></i> {{ __('Role &
                        Permissions Management') }}</a>
                    <a href="/div" class="list-group-item childlist" style="font-size: 13px!important;"> <i
                            class="bullet-point"><span></span></i> Add Division
                    </a>
                    @endif
                </div>
        ...
        -->
                ...
                <a href="#settings" class=" list-group-item" data-toggle="collapse" data-parent="#MainMenu"
                    style="font-size: 16px!important;"><i class="fa fa-cog sidebar-icon"></i><span
                        id="menu-txt">Report</span>
                    <i class="icon ion-md-arrow-dropup arrow-side sidebar-arrow"></i></a>
                <div class="collapse" id="settings">
                   ...
                   -->
                    ...
                    @if(Auth::user()->user_flag == 2)
                    <a href="/testsup" class="list-group-item childlist" style="font-size: 13px!important;"> <i
                            class="bullet-point"><span></span></i>Get QC & Done KPI Report</a>
                    @else
                    <a href="/test" class="list-group-item childlist" style="font-size: 13px!important;"> <i
                            class="bullet-point"><span></span></i>Get QC & Done KPI Report</a>
                    @endif
                    @if(Auth::user()->user_flag == 2)
                    <a href="/overduesup" class="list-group-item childlist" style="font-size: 13px!important;"> <i
                            class="bullet-point"><span></span></i>Get Deadline Tasks Report</a>
                    @else

                    <a href="/overdue" class="list-group-item childlist" style="font-size: 13px!important;"> <i
                            class="bullet-point"><span></span></i>Get Deadline Tasks Report</a>
                    @endif
                    @if(Auth::user()->user_flag == 2)
                    <a href="/menusssup" class="list-group-item childlist" style="font-size: 13px!important;"> <i
                            class="bullet-point"><span></span></i>Get Duration Progressing-Done</a>
                    @else
                    <a href="/menuss" class="list-group-item childlist" style="font-size: 13px!important;"> <i
                            class="bullet-point"><span></span></i>Get Duration Progressing-Done</a>
                    @endif
                ...
                <div class="collapse" id="settings">
                   ...
                   -->
                    <a href="{{ route('roles.index')}}" class="list-group-item childlist"
                        style="font-size: 16px!important;"> <i class="bullet-point"><span></span></i> {{ __('Role &
                        Permissions Management') }}</a>
                    <!--<a href="{{ route('integrations.index')}}"
                       class="list-group-item childlist"> <i
                                class="bullet-point"><span></span></i> {{ __('Integrations') }}</a>-->
                ...
                <div class="collapse" id="settings">
                    <!-- <a href="{{ route('settings.index')}}"
                       class="list-group-item childlist"> <i
                                class="bullet-point"><span></span></i> {{ __('Overall Settings') }}</a>
                   -->
                    <a href="{{ route('roles.index')}}" class="list-group-item childlist"> <i
