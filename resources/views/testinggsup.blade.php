            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <form action="{{ route('filteringgsup') }}" method="GET" style="margin-top: 10%; ">
                        ...
                        <div class="col-sm-3">
                            ...
                            <select name="color_id" id="input">
                                <option value="0">Select Status</option>
                                    ...
                                    <option value="Progressing" {{  $selected_id['price_id'] ? 'selected' : '' }}>
                                        Progressing
                                        </option>
                    ...
                    <div class="col-sm-3">
                        ...
                        <table class="table table-responsive" style="margin-top:5%; margin-left:-20%!important;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $loop->index+1 }}</td>
                                    <td><a href="tasks/{{$product->external_id}}">{{ $product->title }}</a></td>
                                    <td>{{$product->pt}}</td>
                                    <td>{{ $product->text }}</td>
                                    <td>{{$product->name}}</td>
