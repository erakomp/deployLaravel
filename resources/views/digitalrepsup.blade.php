            ...
            <div class="row justify-content-center">
                <div class="col-md-10">
                    <div class="card">
                        ...
                        <form action="{{ route('filterrepsup') }}" method="GET" onchange="postdata(this.value)"
                            ...
                            <select name="price_id" id="input" style="margin-right:2%;">
                                ...
                                ->select('id',
                                'title')->where('source_type','=','App\Models\Task')->orderBy('id')->get() as $country)
                            ...
                            <input type="date" name="from" id="input"
                                value="{{Carbon\Carbon::now()->toDatetimelocalString()}}" style="margin-right:2%;">
                                
                            <input type="date" name="to" id="input"
                                value="{{Carbon\Carbon::now()->toDatetimelocalString()}}" style="margin-right:2%;">

                            <input type="submit" class="btn btn-md btn-brand movedown" value="Filter"
