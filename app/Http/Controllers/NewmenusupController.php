...
use DateTime;
class NewmenusupController extends Controller
{
...
->join('divs', 'tasks.flag', '=', 'divs.id')
    ...
    ->join('projects', 'tasks.project_id', '=', 'projects.id')
        ->select('activities.id', 'activities.text', 'activities.log_name', 'activities.created_at','users.name', 'tasks.title', 'projects.title as pt', 'tasks.status_id', 'tasks.updated_at', 'tasks.created_at as tc', 'tasks.flag', 'divs.division', 'tasks.external_id')
