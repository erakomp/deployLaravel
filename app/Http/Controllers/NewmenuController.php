...
$all_pro =  Activity::join('tasks', 'activities.source_id', '=', 'tasks.id')
    ...
    ->join('projects', 'tasks.project_id', '=', 'projects.id')
        ->select('activities.id', 'activities.text', 'activities.log_name', 'activities.created_at','users.name', 'tasks.title', 'projects.title as pt', 'tasks.status_id', 'tasks.updated_at', 'tasks.created_at as tc', 'tasks.flag')
    ...
    // $selected_id['color_id'] = $request->color_id;
                ...
                ->get();
                $getDiv = Div::all();
    return view('testingg',compact('all_pro','product','selected_id', 'getDiv','get_task_id', 'duration', 'from', 'to'));
    }
